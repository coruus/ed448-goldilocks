...
/*  goldilocks_derive_challenge(challenge,
  ...
  memset_s((uint8_t *)tk, sizeof(tk), 0, sizeof(tk));
  memset_s((uint8_t *)skw, sizeof(skw), 0, sizeof(skw));
  memset_s((uint8_t *)challenge, sizeof(challenge), 0, sizeof(challenge));
  memset_s(&ctx, sizeof(hash_ctx_t), 0, sizeof(hash_ctx_t));
  memset_s(&mctx, sizeof(hash_ctx_t), 0, sizeof(hash_ctx_t));
...
void goldilocks_destroy_precomputed_public_key(
  ...
  memset_s(&precom->pub.opaque, sizeof(precom->pub), 0, sizeof(precom->pub));
  free(precom);
}
