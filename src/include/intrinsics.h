...
/** @brief Macro to make a function static, forcibly inlined and possibly
 * unused. */
#define INTRINSIC \
...
#ifndef likely
#define likely(x)                                                         \
  __builtin_expect((x), 1) /**< @brief Tell the compiler that a branch is \
                              likely, for optimization. */
#define unlikely(x)                                                       \
  __builtin_expect((x), 0) /**< @brief Tell the compiler that a branch is \
                              unlikely, for optimization. */
#endif
